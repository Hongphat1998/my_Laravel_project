...
class NguoiTimViecSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        DB::table('nguoitimviec')->truncate();
        ...
        for ($i=0; $i < $count ; $i++) { 
        	...
        	DB::table('nguoitimviec')->insert(
	            [
					"hinh" =>  Arr::random(['default.png','person_2.jpg','person_6.jpg']),
					"hoten" => $name,
					"emaillienhe" => $email,
